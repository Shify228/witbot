...
async def start(msg: Message) -> None:
    await msg.mark("Привет, я бот для взаимодействия с LLM! Бот создан Хадыевым Д.Р. БИК2405.")
@router.message(Command("help"))
async def help(msg: Message) -> None:
    await msg.answer("Можете написать мне сообщение, а я постараюсь вам на него ответить!")
